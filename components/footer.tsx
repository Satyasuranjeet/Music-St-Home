      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-400 text-center max-w-md mb-8">
            JStream blends music, emotion, and social interaction into a unified, enjoyable experience. Join us today
            and revolutionize the way you listen to music.
          </p>
          ...
          <div className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} JStream. All rights reserved.</div>
        </div>
      </div>
    </footer>
  )
